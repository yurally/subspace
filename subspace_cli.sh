...
mkdir $HOME/subspace; \
cd $HOME/subspace && \
wget https://github.com/subspace/subspace-cli/releases/download/v0.3.3-alpha/subspace-cli-ubuntu-x86_64-v2-v0.3.3-alpha -O subspace-cli && \
...
mkdir $HOME/subspace; \
cd $HOME/subspace && \
wget https://github.com/subspace/subspace-cli/releases/download/v0.3.3-alpha/subspace-cli-ubuntu-x86_64-v3-v0.3.3-alpha -O subspace-cli && \
sudo chmod +x subspace-cli && \
sudo mv subspace-cli /usr/local/bin/ && \
cd $HOME && \
/usr/local/bin/subspace-cli init
