...
cd ${disk}:\Autonomys
powershell -command "& { iwr https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-28/subspace-farmer-windows-x86_64-skylake-mainnet-2024-nov-28.exe -OutFile subspace-farmer.exe }"
powershell -command "& { iwr https://github.com/autonomys/subspace/releases/download/mainnet-2024-nov-28/subspace-node-windows-x86_64-skylake-mainnet-2024-nov-28.exe -OutFile subspace-node.exe }"
