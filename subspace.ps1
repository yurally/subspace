...
write-host "╚══════╝ ╚═════╝ ╚═════╝ ╚══════╝╚═╝     ╚═╝  ╚═╝ ╚═════╝╚══════╝"
write-host "================================================================="
write-host -e "https://subspace.network/"
write-host "================================================================="
write-host "================================================================================"
...
Start-Process PowerShell.exe -ArgumentList ".\subspace-farmer-windows-x86_64-gemini-2a-2022-oct-06.exe --base-path D:\Subspace\subspace-farmer farm  --reward-address $walletaddress --plot-size $plotsize"
